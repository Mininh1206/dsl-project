...
public class ContextSlimmerTest {
    ...
    public void testThrowsWhenInputSlotEmpty() {
        ...
        ContextSlimmer slimmer = new ContextSlimmer("slimmer-3", input, context, output);
    ...
    public void testThrowsWhenContextSlotEmpty() {
        ...
        // Solo establecer el input, no el contexto
        Document doc = TestUtils.createXMLDocument(TestUtils.SAMPLE_XML);
        input.setMessage(new Message("msg-4", doc));
        
        ContextSlimmer slimmer = new ContextSlimmer("slimmer-4", input, context, output);
