...
public class Main {
    ...
    private static void cafeImplementation() {
        try {
            ...
            if (flow.isConcurrent()) {
                System.out.println("Waiting for flow quiescence...");
                iia.dsl.framework.core.ExecutionEnvironment.getInstance().waitForQuiescence(15000);
                System.out.println("Flow quiescence reached or timed out.");
