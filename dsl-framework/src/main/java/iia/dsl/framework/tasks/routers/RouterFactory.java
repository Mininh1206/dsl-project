...
/**
 * Factoría para la creación simplificada de tareas de Enrutamiento (Routers).
 * Centraliza la instanciación de Filters, Correlators, Mergers, Distributors y
 * Replicators.
 */
